...
for i in range(1696):
    print(i)
    file_pos= sys.argv[1]+'/archive/split'+str(i)+'_makedonia.txt' # dataset with part of speech tags
    file_ner= sys.argv[2]+'/archive/split'+str(i)+'_makedonia.txt.tagged' # dataset with named entities
